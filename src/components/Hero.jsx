  ...
  return (
    <div className="w-full h-[400px] lg:h-[480px]">
      <div className="w-full h-full">
        <div className="absolute w-full h-[400px] lg:h-[480px] bg-gradient-to-r from-black" />
        <img
        ...
        <div className="absolute w-full top-[15%] lg:top-[25%] p-4 md:p-8">
          ...
          <div className="mt-8 mb-4">
            <button className="border bg-gray-300 py-2 px-5 rounded-sm text-black">
              Play
            </button>
            <button className="border border-gray-300 py-2 px-5 rounded-sm ml-4">
              Watch Later
            </button>
          </div>
